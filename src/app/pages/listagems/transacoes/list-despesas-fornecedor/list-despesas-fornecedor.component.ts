...
@Component({
  selector: 'app-list-despesas-fornecedor',
  templateUrl: './list-despesas-fornecedor.component.html',
  styleUrls: ['./list-despesas-fornecedor.component.css'],
  animations: [
...
export class ListDespesasFornecedorComponent implements OnInit {
  private configFuncoesBasicas = {
    tipoItem: this.CONSTS.DESPESAS.DESPESA_FORNECEDOR,
    rota: '/pages/cadastros/transacoes/caddespesafornecedor'
  }
