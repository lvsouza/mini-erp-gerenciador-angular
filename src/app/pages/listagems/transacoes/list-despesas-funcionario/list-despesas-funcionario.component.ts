...
@Component({
  selector: 'app-list-despesas-funcionario',
  templateUrl: './list-despesas-funcionario.component.html',
  styleUrls: ['./list-despesas-funcionario.component.css'],
  animations: [
...
export class ListDespesasFuncionarioComponent implements OnInit {
  private configFuncoesBasicas = {
    tipoItem: this.CONSTS.DESPESAS.DESPESA_FUNCIONARIO,
    rota: '/pages/cadastros/transacoes/caddespesafuncionario'
  }
